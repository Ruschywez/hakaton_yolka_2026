...
"""
    ...
    Вкратце: служит для загрузки настроек подключения к БД, а в случае их отсуствия прямо просит ввести данные.
    Даже занимается валидацией введённых данных. Крутяяяк
"""
